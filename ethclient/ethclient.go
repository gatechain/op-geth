...
// EstimateGasAt tries to estimate the gas needed to execute a specific transaction based on
// the state of the specified block number of the backend blockchain.
