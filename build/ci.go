...
import (
	...
	"github.com/gatechain/op-geth/crypto/signify"
	"github.com/gatechain/op-geth/internal/build"
...
func buildFlags(env build.Environment, staticLinking bool, buildTags []string) (flags []string) {
	var ld []string
	if env.Commit != "" {
		ld = append(ld, "-X", "github.com/gatechain/op-geth/internal/version.gitCommit="+env.Commit)
		ld = append(ld, "-X", "github.com/gatechain/op-geth/internal/version.gitDate="+env.Date)
	}
